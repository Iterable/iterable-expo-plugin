...
/**
 * Add a dependency to androids project build.gradle file.
 */
export function addAndroidProjectDependency(
  buildGradle: string,
...
/**
 * Add a dependency to the android app build.gradle file.
 */
export function addAndroidAppDependency(
  buildGradle: string,
...
/**
 * Add the apply plugin line to the android app build.gradle file if it doesn't exist.
 */
export function addAndroidApplyPlugin(
