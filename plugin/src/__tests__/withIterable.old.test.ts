...
describe('withIterable', () => {
  ...
  // });
  it.skip('should store all config values in Info.plist', async () => {
    const config = {
      name: 'TestApp',
      slug: 'test-app',
      ios: { infoPlist: {} },
    ...
    expect(modifiedInfoPlist).toEqual(
  ...
  it.skip('should apply provided props', async () => {
    const config = {
      name: 'TestApp',
      slug: 'test-app',
      ios: {
...
describe('withStoreValuesOnIos', () => {
  ...
  it('should handle boolean values correctly', async () => {
    ...
    expect(infoPlist.ITERABLE_ENABLE_IN_APP_MESSAGES).toBe(false);
  });
